 ...
 * or updating the ZipMBMode in Z/IP Gateway CONFIGURATION FILE ( <a href="zip.html">Manual page of zipgateway </a>).
 *
 * As mentioned in above, the mailbox settings are configured using Z/IP Gateway configuration file or sending Z-Wave commands from Z/IP Clients.
...
/**
 * Maximum number of entries the mailbox can hold. This number is a shared capasity among all the sleeping devices in the network.
 */
...
/**
 * Returns true if mailbox is in state MB_IDLE.
 */
bool mb_idle(void);
