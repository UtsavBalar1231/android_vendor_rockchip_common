 ...
 * field plus the temp associations (temp associations are not persisted). In
 * order to not change the eeprom size we keep the table size definition as
 * before.
 */
...
/**
 * Load IP association table from persistent storage.
 */
