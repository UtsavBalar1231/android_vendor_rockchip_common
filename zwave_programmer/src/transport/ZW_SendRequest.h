 ...
 * For e.g. Multi channel endpoint find expectes more multi channel find report
 * frames in response if the device has big number of endpoints which can not
 * fit in on Z-wave frame.
 */
